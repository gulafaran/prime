...
extern void set_env_vars()
{
    ...
    set_env_var("DRI_PRIME", "1", 1);
}

extern void print_env_vars()
{
    print_env_var("_EGL_VENDOR_LIBRARY_FILENAMES");
    print_env_var("DXVK_FILTER_DEVICE_NAME");
    print_env_var("VKD3D_FILTER_DEVICE_NAME");
    print_env_var("VK_ICD_FILENAMES");
    print_env_var("__NV_PRIME_RENDER_OFFLOAD");
    print_env_var("__NV_PRIME_RENDER_OFFLOAD_PROVIDER");
    print_env_var("__VK_LAYER_NV_optimus");
    print_env_var("__GLX_VENDOR_LIBRARY_NAME");
    print_env_var("DRI_PRIME");
}
